Meetin::Application.configure do
  ...
  config.assets.precompile += ['show.css', 'jquery.placeholder.js', 'base.css' ]
  ...
  config.action_mailer.default_url_options = { host: 'tmeetin.com' }
